...
class TodoItemsControllerTest < ActionController::TestCase
  ...
  test "should create todo_item" do
    assert_difference('TodoItem.count') do
      post :create, todo_item: { description: @todo_item.description, hidden: @todo_item.hidden, starred: @todo_item.starred }
    end
  ...
  test "should update todo_item" do
    patch :update, id: @todo_item, todo_item: { description: @todo_item.description, hidden: @todo_item.hidden, starred: @todo_item.starred }
    assert_redirected_to todo_item_path(assigns(:todo_item))
  end
